...
insert into financas_pessoais.lancamento (mes, categoria, tipo, valor) values    ('janeiro', 'Salário', 'receita', 4000 );
...
insert into financas_pessoais.lancamento (mes, categoria, tipo, valor) values	( 'marco', 'Internet', 'despesa', 200 );
